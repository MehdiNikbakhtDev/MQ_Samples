...
class Program
{
    static void Main(string[] args)
    {
        ...
        channel.QueueBind("TopicQueue.queue1", "ex.topic", "*.image.*");
        channel.QueueBind("TopicQueue.queue2", "ex.topic", "#.image");
        channel.QueueBind("TopicQueue.queue3", "ex.topic", "image.#");
